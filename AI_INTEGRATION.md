...
已成功将AI接入模拟法庭系统，实现交互式庭审对话。用户可以选择原告或被告身份，AI将分别扮演对方律师和法官角色。
...
1. **选择身份**：在案件创建页面选择"原告"或"被告"
2. **选择法官类型**：在庭审页面选择法官类型（专业型、强势型、偏袒型、中立型）
3. **开始庭审**：点击"开始庭审"按钮，法官会宣布开庭
4. **交互对话**：
   - 在输入框中输入您的发言
   - 点击"发送"或按 `Ctrl+Enter`
   - AI会自动生成对方律师和法官的回复
5. **结束庭审**：当法官宣布休庭时，可以生成判决书
